    ...
    onSubmit: async () => {
      ...
      try {
        if (image) {
          ...
          console.log("presett",process.env.REACT_APP_CLOUDINARY_UPLOAD_PRESET)
          const resCloudinary = await axios.post(`https://api.cloudinary.com/v1_1/dmudjg7gl/image/upload`, formData)
                ...
                <Col xl={4}>
                  <div className="form-group">
                    ...
                    <Select
                      ...
                      name="author"
                      onChange={(option) => {
                        formik.setFieldValue("author", option)
                      }}
                      options={authorList}
                    />
                  </div>
